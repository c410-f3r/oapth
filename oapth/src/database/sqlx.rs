use crate::{database::Database, sm::Config, DatabaseTy, Identifier};
use alloc::{string::String, vec::Vec};
use futures::TryStreamExt;
use sqlx_core::{connection::Connection, executor::Executor, query::query};
...
create_sqlx_backend!(
  ...
  /// use oapth::{sm::Config, database::SqlxMysql};
...
create_sqlx_backend!(
  ...
  #[cfg_attr(not(feature = "_integration-tests"), doc = "```ignore,rust")]
  /// # #[tokio::main] async fn main() -> oapth::Result<()> {
  /// use oapth::{database::SqlxPostgres, sm::Config};
...
create_sqlx_backend!(
  ...
  #[cfg_attr(not(feature = "_integration-tests"), doc = "```ignore,rust")]
  /// # #[tokio::main] async fn main() -> oapth::Result<()> {
  /// use oapth::{sm::Config, database::SqlxSqlite};
